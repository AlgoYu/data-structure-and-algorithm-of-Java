...
import cn.machine.geek.algorithm.compression.HuffmanCoding;
import cn.machine.geek.algorithm.interview.AlphanumericSort;
import cn.machine.geek.algorithm.other.*;
import cn.machine.geek.algorithm.search.*;
import cn.machine.geek.algorithm.search.*;
import cn.machine.geek.algorithm.sort.internal.insertion.InsertionSort;
import cn.machine.geek.algorithm.sort.internal.insertion.ShellSort;
import cn.machine.geek.algorithm.sort.internal.merge.MergeSort;
import cn.machine.geek.algorithm.sort.internal.radix.RadixSort;
import cn.machine.geek.algorithm.sort.internal.selection.HeapSort;
import cn.machine.geek.algorithm.sort.internal.selection.SelectionSort;
import cn.machine.geek.algorithm.sort.internal.swap.BubbleSort;
import cn.machine.geek.algorithm.sort.internal.swap.QuickSort;
import cn.machine.geek.datastructure.graphic.AdjacencyMatrix;
import cn.machine.geek.datastructure.linear.*;
import cn.machine.geek.datastructure.tree.*;
import cn.machine.geek.algorithm.other.*;
import cn.machine.geek.datastructure.linear.*;
import cn.machine.geek.datastructure.tree.*;
